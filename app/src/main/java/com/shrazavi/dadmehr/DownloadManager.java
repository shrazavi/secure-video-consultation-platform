...
public class DownloadManager {
    ...
    private String downloadUrl = "", downloadFileName = "",downloadPath = "";
    private ProgressDialog progressDialog;

    public DownloadManager(Context context, String downloadUrl, String downloadPath) {
...
//                        public void onClick(DialogInterface dialog, int id) {
//                            File pdfFile = new File(downloadPath + downloadFileName);  // -> filename = maven.pdf
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                if (new CheckForSDCard().isSDCardPresent()) {
                    ...
                    apkStorage = new File(downloadPath);
                } else
