package com.shrazavi.dadmehr.core.engine.webrtc;
...
import com.shrazavi.dadmehr.core.engine.IEngine;
import com.shrazavi.dadmehr.core.render.ProxyVideoSink;
...
public class WebRTCEngine implements IEngine, Peer.IPeerEvent {
    ...
    public void joinRoom(List<String> userIds) {
        for (String id : userIds) {
            ...
            Peer peer = new Peer(_factory, iceServers, id, this,mIsAudioOnly);
            peer.setOffer(false);
            // add localStream
    ...
    public void userIn(String userId) {
        // create Peer
        Peer peer = new Peer(_factory, iceServers, userId, this,mIsAudioOnly);
        peer.setOffer(true);
        // add localStream
        peer.addLocalStream(_localStream);
        // 添加列表
...
//        }
    ...
    public void disconnected(String userId, EnumType.CallEndReason reason) {
        Log.e("disconnect", "reason= " + "webrtc");
        if (mCallback != null) {
    ...
    public void onDisconnected(String userId) {
        if (mCallback != null) {
           Log.e(TAG, "onDisconnected mCallback != null");
