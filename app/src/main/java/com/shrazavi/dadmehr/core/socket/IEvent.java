package com.shrazavi.dadmehr.core.socket;
...
public interface IEvent {
    ...
    void onInvite(String room, boolean audioOnly, String inviteId, List<String> userList);
...
void onPeers(String myId, List<String> userList);
